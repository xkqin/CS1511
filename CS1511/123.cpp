#include <iostream>
using namespace std;
void total(double price_of_the_house,double down_payment);
...
{
 cout<<"You enter a negative number please enter a positive:\n";
 cin>>price_of_the_house;
}
...
total(price_of_the_house,down_payment);
...
void total(double price_of_the_house,double down_payment)
{
  ...
  cout<<"Total is"<<0.03*initial_loan_balance+interest-annual_tax<<endl;
}
 double getinterest(double initial_loan_balance)
{
